...
class AgendaServices(BaseServices):
    ...
    async def create(self, data: schemas.CreateRequest, commons: CommonsDependencies) -> dict:
        ...
        data_save = models.Agendas(**data).model_dump()
...
agenda_crud = BaseCRUD(database_engine=app_engine, collection="agendas")
agenda_services = AgendaServices(service_name="agendas", crud=agenda_crud)
