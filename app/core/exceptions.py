...
class ErrorCode:
    ...
    def InvalidUrl(url: str):
        return CustomException(type="core/info/invalid-url", status=400, title="Invalid URL format.", detail=f"The {url} is not a valid URL. Please provide a valid URL and try again.")
